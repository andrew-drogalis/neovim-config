    ...
    config = function(_, opts)
        ...
        vim.api.nvim_create_autocmd("LspAttach", {
            ...
            callback = function(ev)
                ...
                keymap.set("n", "<leader>li", "<cmd>Telescope lsp_implementations<CR>", vim.tbl_extend("force", opts, {
                    desc = "Show LSP implementations"
                }))
                keymap.set("n", "<leader>lt", "<cmd>Telescope lsp_type_definitions<CR>", vim.tbl_extend("force", opts, {
                ...
                keymap.set("n", "<leader>lb", "<cmd>Telescope diagnostics bufnr=0<CR>", vim.tbl_extend("force", opts, {
